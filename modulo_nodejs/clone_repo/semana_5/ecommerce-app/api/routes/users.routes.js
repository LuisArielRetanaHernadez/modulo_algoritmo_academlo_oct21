...
router
	.route('/:id')
	.get(protectSession, protectUser, getUserById)
	.patch(protectSession, protectUser, updateUserValidations, validateResult, updateUser)
	.delete(protectSession, protectUser, disableUserAccount);
