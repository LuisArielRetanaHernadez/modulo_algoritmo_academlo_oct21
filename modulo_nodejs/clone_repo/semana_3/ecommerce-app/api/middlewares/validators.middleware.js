...
exports.createProductValidation = [
	body('name').isString().notEmpty().withMessage('nombre vacio'),
	body('desccription').isString().notEmpty().withMessage('description vacio'),
	body('quantity').isNumber().withMessage('debe ser numerico la cantidad'),
	body('price').isNumber().withMessage('debe ser numerico la cantidad'),
